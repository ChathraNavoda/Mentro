...
import 'package:mentro/presentation/screens/home/emotions/widgets/gratitude_snap_task.dart';
import 'package:mentro/presentation/screens/home/emotions/widgets/highlight_reel_task.dart';
import 'package:mentro/presentation/screens/home/emotions/widgets/kindness_bomb_task.dart';
import 'package:shared_preferences/shared_preferences.dart';

class HappyScreen extends StatefulWidget {
  final VoidCallback onComplete;
  const HappyScreen({super.key, required this.onComplete});
...
class _HappyScreenState extends State<HappyScreen>
  ...
  Future<void> checkCompletionState() async {
    ...
    final timeStr = prefs.getString('happy_time_$uid');
  ...
  Future<void> saveCompletionState() async {
    ...
    await prefs.setString('happy_time_$uid', DateTime.now().toIso8601String());
  }
  ...
  Widget buildCountdownBanner() {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          const Icon(Icons.timer, color: Color(0xFFEDEEA5)),
          const SizedBox(width: 8),
          Text(
            'You can cheer again in',
      ...
      body: Column(
        children: [
          TabBar(
            ...
            labelColor: const Color(0xFFEDEEA5),
            unselectedLabelColor: Colors.black,
            dividerColor: Colors.black87,
            indicatorColor: const Color(0xFFEDEEA5),
            unselectedLabelStyle:
                GoogleFonts.outfit(fontSize: 15, fontWeight: FontWeight.w400),
            labelStyle:
                GoogleFonts.outfit(fontSize: 15, fontWeight: FontWeight.w400),
            tabs: const [
              Tab(icon: Icon(Icons.camera_alt), text: "Snap"),
              Tab(icon: Icon(Icons.card_giftcard), text: "Kindness"),
              Tab(icon: Icon(Icons.video_library), text: "Highlight"),
            ],
          ),
          Expanded(
            child: TabBarView(
          ...
          Padding(
            ...
            child: Column(
              children: [
                Text(
                  allCompleted
                      ? "🌈 You celebrated happiness beautifully!"
